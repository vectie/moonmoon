...
const runtimeTargetPath = fileURLToPath(new URL('./.generated/live-moonrobo-noetix-runtime.js', import.meta.url))
const evidenceTargetPath = fileURLToPath(new URL('./.generated/live-moonrobo-suite-evidence.js', import.meta.url))
...
console.log(`wrote ${runtimeTargetPath}`)
console.log(`wrote ${evidenceTargetPath}`)

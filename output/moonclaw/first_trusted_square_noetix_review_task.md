...
- moonclaw/first-trusted-square/noetix-review-task
  ...
  - artifacts:
    ...
    - noetix-endless-gait-window: output/moonrobo/first_trusted_square_noetix_endless_gait.json
      - current: cycle 32 frames; frame 0 repeats at 32; forward offset 0.384 m; status endless-gait-window-verified
      - ready: true
      - blocking: none
    ...
    - noetix-urdf-reference-link-poses: output/moonrobo/first_trusted_square_noetix_link_poses.json
      - current: 32 frames; 25 links per frame; rig urdf-rigid-rig-ready; motion planned-gait-joint-samples; rig-motion robot-rig-motion-contract-ready; 6 rigid visuals (1 mesh, 5 primitives); rig contract urdf-rigid-visual-contract-ready; collision metadata links 0; inertial metadata links 0; missing collision links 25; missing inertial links 25; status review-only
      - ready: true
      - blocking: none
